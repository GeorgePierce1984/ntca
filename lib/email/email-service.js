...
const EMAIL_CONFIG = {
  from: {
    name: process.env.EMAIL_FROM_NAME || 'NTCA Platform',
    email: process.env.EMAIL_FROM_ADDRESS || 'onboarding@resend.dev' // ⚠️ Test domain - only sends to account owner!
  },
  replyTo: process.env.EMAIL_REPLY_TO || 'onboarding@resend.dev',
  defaultDomain: process.env.NEXT_PUBLIC_APP_URL || 'https://www.nt-ca.com'
};
